<article id="Riley_Rewington" class="media">
	...
	<img class="pull-left img-rounded" src="img/artists/Riley_Rewington_tn.jpg" alt="Photo of Riley Rewington">
	<div class="media-body">
		...
		<section class="modalphotos photogrid">
			<h3>Artwork</h3>
			<img src="img/artwork/Riley_Rewington_01_tn.jpg" alt="Art from Riley Rewington">
			<img src="img/artwork/Riley_Rewington_02_tn.jpg" alt="Art from Riley Rewington">
			<img src="img/artwork/Riley_Rewington_03_tn.jpg" alt="Art from Riley Rewington">
			<img src="img/artwork/Riley_Rewington_04_tn.jpg" alt="Art from Riley Rewington">
			<img src="img/artwork/Riley_Rewington_05_tn.jpg" alt="Art from Riley Rewington">
			<img src="img/artwork/Riley_Rewington_06_tn.jpg" alt="Art from Riley Rewington">
		</section>
	</div><!-- media body -->
</article>
